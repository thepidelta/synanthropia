...
const i18n = {
  el: {
    ...
    members_body: "Η ενότητα παρουσιάζει τον τρόπο συμμετοχής μελών και τη συνεργασία με εταίρους που στηρίζουν το έργο της Συνανθρωπιάς.",
    ...
    member_form_coming_soon: "Για αίτηση μέλους μπορείτε να επικοινωνήσετε μαζί μας στο info@synanthropia.org.",
    ...
    submit_interest_soon: "Επικοινωνήστε μαζί μας",
    ...
    social_coming_soon: "Για δημόσιες ενημερώσεις μπορείτε να επικοινωνείτε μαζί μας μέσω email ή τηλεφώνου.",
    location_value: "Θυμάρι Παλαιάς Φώκαιας, συμβολή Σόλωνος και Σεφέρη, Τ.Κ. 19013",
  ...
  en: {
    ...
    members_body: "This section presents how members can participate and how partners contribute to the work of Synanthropia.",
    ...
    member_form_coming_soon: "For membership applications, please contact us at info@synanthropia.org.",
    ...
    submit_interest_soon: "Contact us",
    btn_clear: "Clear",
    ...
    social_title: "Social media",
    social_coming_soon: "For public updates, please contact us by email or phone.",
    location_value: "Thymari, Palaia Fokaia, corner of Solonos and Seferi, Postal Code 19013",
  ...
  de: {
    ...
    members_body: "Dieser Bereich zeigt, wie Mitglieder teilnehmen koennen und wie Partner die Arbeit von Synanthropia unterstuetzen.",
    ...
    member_form_coming_soon: "Fuer Mitgliedsantraege kontaktieren Sie uns bitte unter info@synanthropia.org.",
    ...
    submit_interest_soon: "Kontaktieren Sie uns",
    btn_clear: "Leeren",
    ...
    social_coming_soon: "Fuer oeffentliche Aktualisierungen kontaktieren Sie uns bitte per E-Mail oder Telefon.",
    location_value: "Thymari, Palaia Fokaia, Ecke Solonos und Seferi, Postleitzahl 19013",
